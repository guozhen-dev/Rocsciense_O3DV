OV.Website = class {
    ...
    async LoadModelFromUrlList(urls, settings, callback) {
        await this.modelLoader.LoadFromUrlList(urls, settings);
    ...
    async LoadModelFromFileList(files) {
        ...
        if (fileExt == 'rsexp') {
            this.modelLoader.LoadFromRSExport(files, this.importSettings, this);
        } else {
